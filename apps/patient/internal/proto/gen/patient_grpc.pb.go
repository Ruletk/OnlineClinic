...
const (
	PatientService_CreatePatient_FullMethodName = "/patient.PatientService/CreatePatient"
...
type PatientServiceClient interface {
	CreatePatient(ctx context.Context, in *PatientRequest, opts ...grpc.CallOption) (*PatientResponse, error)
	GetPatient(ctx context.Context, in *GetPatientRequest, opts ...grpc.CallOption) (*PatientResponse, error)
	UpdatePatient(ctx context.Context, in *PatientRequest, opts ...grpc.CallOption) (*PatientResponse, error)
...
func (c *patientServiceClient) CreatePatient(ctx context.Context, in *PatientRequest, opts ...grpc.CallOption) (*PatientResponse, error) {
...
func (c *patientServiceClient) GetPatient(ctx context.Context, in *GetPatientRequest, opts ...grpc.CallOption) (*PatientResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PatientResponse)
...
func (c *patientServiceClient) UpdatePatient(ctx context.Context, in *PatientRequest, opts ...grpc.CallOption) (*PatientResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PatientResponse)
...
type PatientServiceServer interface {
	CreatePatient(context.Context, *PatientRequest) (*PatientResponse, error)
	GetPatient(context.Context, *GetPatientRequest) (*PatientResponse, error)
	UpdatePatient(context.Context, *PatientRequest) (*PatientResponse, error)
...
func (UnimplementedPatientServiceServer) CreatePatient(context.Context, *PatientRequest) (*PatientResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreatePatient not implemented")
}
func (UnimplementedPatientServiceServer) GetPatient(context.Context, *GetPatientRequest) (*PatientResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPatient not implemented")
}
func (UnimplementedPatientServiceServer) UpdatePatient(context.Context, *PatientRequest) (*PatientResponse, error) {
...
func _PatientService_CreatePatient_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PatientServiceServer).CreatePatient(ctx, req.(*PatientRequest))
	}
...
func _PatientService_UpdatePatient_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PatientServiceServer).UpdatePatient(ctx, req.(*PatientRequest))
	}
	return interceptor(ctx, in, info, handler)
}
