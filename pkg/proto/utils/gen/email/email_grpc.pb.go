...
const (
	EmailService_Send_FullMethodName = "/proto.EmailService/Send"
)
...
type EmailServiceClient interface {
	Send(ctx context.Context, in *SendEmailRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *emailServiceClient) Send(ctx context.Context, in *SendEmailRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type EmailServiceServer interface {
	Send(context.Context, *SendEmailRequest) (*emptypb.Empty, error)
...
func (UnimplementedEmailServiceServer) Send(context.Context, *SendEmailRequest) (*emptypb.Empty, error) {
...
var EmailService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/proto/utils/email.proto",
}
